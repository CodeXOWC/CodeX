/**
 * Constant Contact Form Design Menu
 *
 * @version 1.0.0
 *
 */
...
//			postboxes.add_postbox_toggles('nav-menus');
			postboxes.add_postbox_toggles('constant-contact_page_constant-contact-forms');
		...
		initSortables : function() {
			var currentDepth = 0, originalDepth = 0, minDepth = 0, maxDepth = 0,
			...
			console.log('initSortables before sortable');
...
//			api.refreshMenuTabs();
	...
	$(document).ready(function(){ wpFormMenu.init(); });
