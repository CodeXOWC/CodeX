...
<head>
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/js/libs/bootstrap-tooltip.js"></script>
        ...
        <div class="<?php echo WRAP_CLASSES; ?>">
         <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <form role="search" method="get" id="searchform" class="form-search <?php if (is_404() || !have_posts()) { ?> well <?php } ?>" action="<?php echo home_url('/'); ?>">
            ...
            <input type="text" value="" name="s" id="s" class="search-query" placeholder="Search MCH">
